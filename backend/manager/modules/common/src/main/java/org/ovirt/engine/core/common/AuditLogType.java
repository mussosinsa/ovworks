...
public enum AuditLogType {
    ...
    USER_UPDATE_CLUSTER_UPGRADE(896),
    USER_UPDATE_CLUSTER_UPGRADE_FAILED(897, AuditLogSeverity.ERROR),
    ...
    OVIRT_PROVIDER_OVN_CERTIFICATE_HAS_EXPIRED(902, AuditLogSeverity.ALERT, AuditLogTimeInterval.DAY.getValue()),
    OVIRT_PROVIDER_OVN_CERTIFICATE_IS_ABOUT_TO_EXPIRE(903, AuditLogSeverity.WARNING, AuditLogTimeInterval.DAY.getValue()),
    OVIRT_PROVIDER_OVN_CERTIFICATE_IS_ABOUT_TO_EXPIRE_ALERT(904, AuditLogSeverity.ALERT, AuditLogTimeInterval.DAY.getValue()),
    ...
    USER_PROFILE_CREATE_PROPERTY(15002),
    USER_PROFILE_CREATE_PROPERTY_FAILED(15003, AuditLogSeverity.ERROR),
    USER_PROFILE_CREATE_OWN_PROPERTY(15004),
    USER_PROFILE_CREATE_OWN_PROPERTY_FAILED(15005, AuditLogSeverity.ERROR),
    USER_PROFILE_REMOVE_PROPERTY(15006),
    USER_PROFILE_REMOVE_PROPERTY_FAILED(15007, AuditLogSeverity.ERROR),
    USER_PROFILE_REMOVE_OWN_PROPERTY(15008),
    USER_PROFILE_REMOVE_OWN_PROPERTY_FAILED(15009, AuditLogSeverity.ERROR),
    USER_PROFILE_REPLACE_PROPERTY(15010),
    USER_PROFILE_REPLACE_PROPERTY_FAILED(15011, AuditLogSeverity.ERROR),
    USER_PROFILE_REPLACE_OWN_PROPERTY(15012),
    USER_PROFILE_REPLACE_OWN_PROPERTY_FAILED(15013, AuditLogSeverity.ERROR),
    ...
    SECURITY_AUDIT_STARTED(13600),
    SECURITY_AUDIT_COMPLETED(13601),
    SECURITY_AUDIT_FAILED(13602, AuditLogSeverity.ERROR),
    SECURITY_AUDIT_WARNING(13603, AuditLogSeverity.WARNING),

    INTEGRITY_VERIFICATION_STARTED(13610),
    INTEGRITY_VERIFICATION_COMPLETED(13611),
    INTEGRITY_VERIFICATION_FAILED(13612, AuditLogSeverity.ERROR),
    INTEGRITY_VERIFICATION_WARNING(13613, AuditLogSeverity.WARNING),
    INTEGRITY_VERIFICATION_FILE_MODIFIED(13614, AuditLogSeverity.WARNING),
    INTEGRITY_VERIFICATION_FILE_MISSING(13615, AuditLogSeverity.ERROR),

    TERMINAL_AUTH_CONFIG_UPDATED(13620),
    TERMINAL_AUTH_CONFIG_UPDATE_FAILED(13621, AuditLogSeverity.ERROR),
    TERMINAL_IP_AUTH_CONFIG_UPDATED(13622),
    TERMINAL_IP_AUTH_CONFIG_UPDATE_FAILED(13623, AuditLogSeverity.ERROR),
    AUDIT_LOG_BACKUP_COMPLETED(13624),
    AUDIT_LOG_BACKUP_FAILED(13625, AuditLogSeverity.ERROR),
    AUDIT_LOG_RESTORE_COMPLETED(13626),
