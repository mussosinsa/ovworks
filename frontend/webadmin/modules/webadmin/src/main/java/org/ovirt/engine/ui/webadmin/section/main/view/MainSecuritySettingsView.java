...
public class MainSecuritySettingsView extends AbstractMainWithDetailsTableView<Object, SecuritySettingsListModel>
    ...
    public MainSecuritySettingsView(MainModelProvider<Object, SecuritySettingsListModel> modelProvider,
        ...
        mainContainer.getElement().setInnerHTML(
            "<div style='display: table; width: 100%; height: 600px;'>" + //$NON-NLS-1$
            "  <div id='sidebar' style='display: table-cell; width: 250px; vertical-align: top; background-color: #ffffff; border-right: 1px solid #ddd;'>" + //$NON-NLS-1$
            ...
            "  </div>" + //$NON-NLS-1$
            "  <div id='contentArea' style='display: table-cell; vertical-align: top; background-color: #ffffff;'></div>" + //$NON-NLS-1$
            "</div>" //$NON-NLS-1$
        );
